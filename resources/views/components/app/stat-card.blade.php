...
<article {{ $attributes->class('rounded-xl border border-zinc-200 bg-white p-5 shadow-sm') }}>
    <div class="flex items-center gap-4">
        ...
        <div class="min-w-0">
            ...
            <p class="mt-1 truncate text-xl font-bold tracking-tight text-zinc-950">{{ $value }}</p>
            <p @class(['mt-1 flex items-center gap-1 text-xs font-medium', 'text-emerald-600' => $trendTone === 'positive', 'text-zinc-500' => $trendTone === 'neutral'])>
